...
如果你的模型训练好了，可以直接用下面的命令:

    echonet segmentation --save_video --run_test --weights E:\Ultrasound\EchoNet-Dynamic\output\segmentation\deeplabv3_resnet50_random\best.pt
